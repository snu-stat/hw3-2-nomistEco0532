[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/g2jk8-eQ)
# Homework 3
...
* [분석 리포트 (HTML)](.tree/gh-pages/hw03.html)
* [분석 리포트 (HTML) full page link](https://snu-stat.github.io/hw3-2-nomistEco0532/hw03.html)
* [주피터 노트북 파일 (ipynb)](./hw03.ipynb)
...
6.  `publish.yml`, `Dockerfile` 등 필요한 경우 수정가능하다.
7.  Repository와 생성된 package는 모두 public이어야한다.
8.  **초기 build후 사이트를 접속할 때 이미 만들어진 my-r-env 패키지의 이미지를 사용한다.**
